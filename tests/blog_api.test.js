...
describe('when there is initially some blogs saved', () => {
  ...
  test('the first one is LTT', async () => {
    ...
    expect(authors).toContain('Linus Sebastian')
  })
})
...
describe('addition of a new blog', () => {
  test('a valid blog can be added, succeeds with status 201 (Created) ', async () => {
    ...
    expect(authors).toContain('Dmitri')
  })
...
describe('attempted addition of new blog with missing values', () => {
  ...
  test('a blog is not added when user token is invalid, status 401', async () => {
    const token =
      'eyJkbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InJvb3QiLCJpZCI6IjY1MDcyM2NiZmYxNTMzYWY2YzNmMjJlZiIsImlhdCI6MTY5NDk2NjczMiwiZXhwIjoxNjk0OTcwMzMyfQ.8g08-aq0CyUjay_WjhEWg-5kW4DgjqppIMllV45djI4'
    const newBlog = {
      title: 'Hardware Canucks',
      author: 'Dimitri',
    }
